      ...
      <div class="form-container">
        <div>
          ...
          <div class="row text-center">
            <h2 class="title-head hidden-xs"><span>Register</h2>
          ...
          <!-- Form Starts -->
            ...
            <center><button type="submit" class="btn btn-primary btn-user btn-block"  onclick="location.href='<?php base_url();?>index'"  style="width:500px">Register Siswa</button>
            <center><button type="submit" class="btn btn-primary btn-user btn-block"  onclick="location.href='<?php base_url();?>index1'"  style="width:500px">Register Guru</button></center>
          <!-- Form Ends -->
        </div>
      </div>
    </div>
