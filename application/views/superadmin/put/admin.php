                ...
                <form action="<?php echo site_url(); ?>SekolahClient/put_process" class="needs-validation" method="POST" enctype="multipart/form-data" onload="setSelectBoxByText()">
                    ...
                    <?php foreach ($user as $rows) : ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" id="password" placeholder="password" value="<?php echo $rows->password; ?>" name="email" required="" >
                        </div>
                        <div class="form-group">
                            <label for="password">Password Baru:</label>
                            <input type="text" class="form-control" id="password" placeholder="password" value="<?php echo $rows->password; ?>" name="email" required="" >
                        </div>
