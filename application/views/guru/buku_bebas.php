                      ...
                      <tbody>
                        ...
                        foreach ($buku_bebas as $rows) : ?>
                          <tr>
                            ...
                            <td>
                              <a href="<?php echo site_url(); ?>BukuBebasClient/put_buku_bebas/<?php echo $rows->id_buku_bebas; ?>" class="btn btn-warning">
                                <i class="fa fa-pen" aria-hidden="true"></i></a>
                              <a href="<?= base_url(); ?>BukuBebasClient/delete_buku_bebas/<?= $rows->id_buku_bebas; ?>" class="btn btn-danger" onClick="return confirm('yakin mau hapus');">
