...
<body>
    ...
    <section class="our_project_area">
        <div class="container">
            <div class="row">
                <div class="col-xs-6">
                    <form action="<?php echo site_url(); ?>SiswaClient/post_process_buku" class="needs-validation" method="POST" enctype="multipart/form-data" onload="setSelectBoxByText()">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <input style="height:40px; width:300px;" type="text" name="nama_buku" class="form-control form-control-user" id="nama_buku" required></input>
                            <span class="text-danger"></span>

                        </div>
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <input style="height:40px; width:300px;" type="hidden" name="id_sekolah" class="form-control form-control-user" id="id_sekolah" value="<?php echo $this->session->userdata('id_sekolah'); ?>" required readonly></input>
                            <span class="text-danger"></span>

                        </div>
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <label for="floatingSelect">Deskripsi :</label>
                            <textarea style="height:96px; width:300px;" type="text" name="diskripsi" class="form-control" id="diskripsi" required></textarea>
                            <span class="text-danger"></span>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                            ...
                            <input type="submit" id="submit" name="register" value="Tambahkan" style="height:40px; width:300px;" class="btn btn-primary btn-user btn-block" />
