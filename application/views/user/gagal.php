    ...
    <div class="container">
      <div class="row">
        <div class="col d-flex flex-column text-center">
          <div class="card-body">
            <img class="animated infinite bounce w-25" src="<?= base_url(); ?>css/assets/img/gagal.png" alt="">
            <br><br>
            <h1>Gagal</h1>
            <h2 class="">Waktu anda habis dalam memberikan ulasan</h2>
            <br>
            <a class='btn btn-danger' href="<?php echo site_url(); ?>SiswaClient/buku">
              <span>
                Kembali
              </span>
            </a>
...
<script>
  setTimeout(() => {
    window.location.href = "<?php echo site_url(); ?>siswaclient";
  }, 10000);
</script>
</body>
