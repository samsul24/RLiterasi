        ...
        <div class="col-md-3">
          <div class="project_left_side">
            ...
            <thead>
                ...
                <th scope="col"><?php echo $rows->id_buku; ?></th>
                </tr>
            </thead>
            <tbody>
                <tr>
            ...
            <!-- <ul class="our_project_filter">
              <li class="active" data-filter="*"><a href="#">ID Buku : <?php echo $rows->id_buku; ?></a></li>
              <li data-filter=".building"><a href="#"><?php echo $rows->nama_buku; ?></a></li>
              <li data-filter=".interior"><a href="#"><?php echo $rows->diskripsi; ?></a></li>
              <li data-filter=".design"><a href="<?php echo site_url(); ?>SiswaClient/ulasan/">">Tulis Ulasan</a></li>
            </ul> -->
          </div>
        </div>
        <div class="col-md-9">
        <!-- <embed src="<?php echo base_url('file_buku/' . $rows->file_pdf) ?>" type="application/pdf" width="100%" height="700px"/> -->
        <iframe src="<?php echo base_url('file_buku/' . $rows->file_pdf) ?>" width="900" height="900"></iframe>
          </div>
          <?php endforeach; ?>
        </div>
      </div>
