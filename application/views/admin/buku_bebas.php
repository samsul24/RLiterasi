        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class='card-header' style="margin-left:-20px;">
                    <a class='btn btn-primary' href="<?php echo site_url(); ?>BukuBebasClient/post/">
                ...
                <div class="dataTable-container">
                    <table class="table table-striped" id="table1">
                        ...
                        <tbody>
                            <?php
                            $i = 1;
                            foreach ($buku_bebas as $rows) : ?>
                                <tr>

                                    <td><?php echo $i++; ?></td>
                                    <td><img src="<?=base_url('file_buku/cover/' .$rows->cover).""?>" width="90" hight="120"></img></td>
                                    ...
                                    <td>
                                        <a href="<?php echo site_url(); ?>BukuBebasClient/put/<?php echo $rows->id_buku_bebas; ?>" class="btn btn-warning">
                                            <i class="bi bi-pen" aria-hidden="true"></i></a>
                                        <a href="<?= base_url(); ?>BukuBebasClient/delete/<?= $rows->id_buku_bebas; ?>" class="btn btn-danger" onClick="return confirm('yakin mau hapus');">
                                            <i class="bi bi-trash" aria-hidden="true"></i></a>
                                            <a href="<?= base_url(); ?>BukuBebasClient/detail/<?= $rows->id_buku_bebas; ?>"><button type="button" class="btn btn-outline-success block"> 
