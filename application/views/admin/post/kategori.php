    ...
    <div class="page-heading">
        ...
        <section class="section">
            ...
            <div class="form-container" style="margin-left:10px">
                ...
                <form action="<?php echo site_url(); ?>AdminClient/post_process_kategori" class="needs-validation" method="POST" enctype="multipart/form-data" onload="setSelectBoxByText()">
                <input type="hidden" name="count" value="<?= $count ?>">
            <?php for ($i = 0; $i < $count; $i++) : ?>
            <div class="form-group row">
                <label for="floatingSelect">Grade <?= $i+1 ?> :</label>
                <input style="height:40px; width:547;" type="text" name="grade" class="form-control form-control-user" id="grade" required></input>
            ...
            <div class="form-group row">
                <label for="floatingSelect">Nilai Start <?= $i+1 ?> :</label>
                <input style="height:40px; width:547;"  type="number" name="start" class="form-control" id="start" required></input>
                <span class="text-danger"></span>
            </div>
            <div class="form-group row">
                <label for="floatingSelect">Nilai End <?= $i+1 ?> :</label>
                <input style="height:40px; width:547;" type="number" name="end" class="form-control" id="end" required></input>
                <span class="text-danger"></span>
            </div>
            <hr>
            <br><br>
