                    ...
                    <div>
                        ...
                        <form action="<?php echo site_url(); ?>Adminlient/put_process_profile" class="needs-validation" method="POST" enctype="multipart/form-data" onload="setSelectBoxByText()">
                            <div class="row no-gutters">
                                <div class="col-md-4">
                                    ...
                                    foreach ($user as $rows) : ?>
                                        <img src="<?= base_url('assets/admin/img/') . $rows->foto ?>" class="card-img" alt="..." width="200%">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                            ...
                            pembuatan,&nbsp;<?= date('d  F Y H:i:s', ($rows->date_created)); ?></small> -->
                                    <?php endforeach ?>
                                    <a href="<?php echo base_url("AdminClient/edit_profile"); ?>" class="btn btn-primary"> <i class="fas fa-pen"></i>&nbsp;Edit</a>
                                    <a href="<?php echo base_url("AdminClient/Change_Password"); ?>" class="btn btn-primary"> <i class="fas fa-key"></i>&nbsp;Ubah Kata Sandi</a>
                                    </p>
                                    </div>
                                </div>
                            </div>
