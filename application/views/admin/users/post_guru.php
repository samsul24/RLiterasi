            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div>
                        ...
                        <!-- Section Title Ends -->
                        <!-- Form Starts -->
                        <form action="<?php echo site_url(); ?>AdminClient/post_process_guru" class="needs-validation" method="POST" enctype="multipart/form-data" onload="setSelectBoxByText()">
                            <div class="form-group row">
                                <label for="floatingSelect">NIP </label>

                                <input style="height:40px; width:547;" type="text" name="nis" class="form-control form-control-user" id="nis" required></input>
                            ...
                            <div class="form-group row">
                                ...
                                <input style="height:40px; width:547;" type="text" name="username" class="form-control form-control-user" id="username" required></input>
                                <span class="text-danger"></span>
                            ...
                            <div class="form-group row">
                                ...
                                <input style="height:40px; width:547;" type="text" name="password" class="form-control form-control-user" id="password" required></input>
                                <span class="text-danger"></span>
                            ...
                            <div class="form-group row">
                                ...
                                <input style="height:40px; width:547;" type="text" name="nama" class="form-control form-control-user" id="nama" required></input>
                                <span class="text-danger"></span>

                            </div>
                            <div class="form-group row">
                                <label for="floatingSelect">Jenis Kelamin (L/P)</label>

                                <input style="height:40px; width:547;" type="text" name="jenis_kelamin" class="form-control form-control-user" id="jenis_kelamin" required></input>
                                <span class="text-danger"></span>
