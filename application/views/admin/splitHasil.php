                ...
                <div class="dataTable-container">
                    <table class="table table-striped dataTable-table" id="table1">
                        <thead>
                            <tr>
                                ...
                                <th data-sortable="" style="width: 11.7015%;"><a href="#" class="dataTable-sorter">Pdf</a></th>
                    ...
                    foreach ($split as $rows) : ?>
                      <tr>
                        ...
                        <td><?php echo $i++; ?></td>
                        <td><iframe src="<?php echo base_url('file_buku/split/' . $rows->pdf_file) ?>" width="90" hight="120"></iframe></td>
                        <td>
                          ...
                          <a href="<?= base_url(); ?>Splitter/split/<?= $rows->id_split; ?>" class="btn btn-success" >
